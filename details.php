...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($_FILES['image']['tmp_name'])) {
        ...
        if (move_uploaded_file($image, $targetFile)) {
            ...
            $query = "   users SET user_name = :name, user_email = :email, user_age = :age, user_address = :address, user_gender = :gender, user_details = :bio, user_interest = :interest, user_image = :imagePath, latitude = :latitude, longitude = :longitude WHERE user_id = :userid";
    ...
    <div class="update-profile">
        <form action="#" method="POST" enctype="multipart/form-data">
            <div class="inputBox">
                ...
                <input type="text" name="name" value="<?php echo $user_info['user_name'] ?>" placeholder="Full Name"
                    readonly /><br />
                <br />

                <label>Email</label>
                <input type="email" name="email" value="<?php echo $user_info['user_email'] ?>" placeholder="Email"
                    readonly /><br />
                <br />
                ...
                <label>Address</label>
                <input id="address-input" type="text" name="address" value="<?php echo $user_info['user_address'] ?>"
                ...
                <textarea id="bio" name="bio" rows="4" cols="50"
                    placeholder="Bio"><?php echo $user_info['user_details'] ?></textarea><br />
                <label>Interest:</label><br />
                <textarea id="interest" name="interest" rows="4" cols="50"
                    placeholder="Write atleast 10 interests"><?php echo $user_info['user_interest'] ?></textarea><br />
